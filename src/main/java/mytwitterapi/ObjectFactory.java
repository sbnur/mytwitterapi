...
interface ObjectFactory extends java.io.Serializable {
	...
	// ResponseList<User> createUserListFromJSONArray(HttpResponse res) throws
	// TwitterException;
	...
	// ResponseList<UserList> createUserListList(HttpResponse res) throws
	// TwitterException;

	// ResponseList<Category> createCategoryList(HttpResponse res) throws
	// TwitterException;

	// DirectMessage createDirectMessage(HttpResponse res) throws
	// TwitterException;

	// ResponseList<DirectMessage> createDirectMessageList(HttpResponse res)
	// throws TwitterException;

	// Relationship createRelationship(HttpResponse res) throws
	// TwitterException;

	// ResponseList<Friendship> createFriendshipList(HttpResponse res) throws
	// TwitterException;
	...
	// ResponseList<SavedSearch> createSavedSearchList(HttpResponse res) throws
	// TwitterException;

	// ResponseList<Location> createLocationList(HttpResponse res) throws
	// TwitterException;

	// Place createPlace(HttpResponse res) throws TwitterException;

	// ResponseList<Place> createPlaceList(HttpResponse res) throws
	// TwitterException;
