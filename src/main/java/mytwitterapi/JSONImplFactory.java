...
public class JSONImplFactory implements ObjectFactory {
	...
	/*
	 * @Override public UserList createAUserList(JSONObject json) throws
	 * TwitterException { return new UserListJSONImpl(json); }
	 */
	 ...
	 *             when coordinates is not included in geo element (should be an
	 *             API side issue)
	 */
	/* package */
	...
	/*
	 * @Override public Trends createTrends(HttpResponse res) throws
	 * TwitterException { return new TrendsJSONImpl(res, conf); }
	 */
	...
	/*
	 * @Override public ResponseList<User>
	 * createUserListFromJSONArray(HttpResponse res) throws TwitterException {
	 * return UserJSONImpl.createUserList(res.asJSONArray(), res, conf); }
	 */

	/*
	 * @Override public ResponseList<User>
	 * createUserListFromJSONArray_Users(HttpResponse res) throws
	 * TwitterException { try { return
	 * UserJSONImpl.createUserList(res.asJSONObject().getJSONArray("users"),
	 * res, conf); } catch (JSONException jsone) { throw new
	...
	/*
	 * @Override public ResponseList<UserList> createUserListList(HttpResponse
	 * res) throws TwitterException { return
	 * UserListJSONImpl.createUserListList(res, conf); }
	 */

	/*
	 * @Override public ResponseList<Category> createCategoryList(HttpResponse
	 * res) throws TwitterException { return
	 * CategoryJSONImpl.createCategoriesList(res, conf); }
	 */

	/*
	 * @Override public DirectMessage createDirectMessage(HttpResponse res)
	 * throws TwitterException { return new DirectMessageJSONImpl(res, conf); }
	 */

	/*
	 * @Override public ResponseList<DirectMessage>
	 * createDirectMessageList(HttpResponse res) throws TwitterException {
	 * return DirectMessageJSONImpl.createDirectMessageList(res, conf); }
	 */

	/*
	 * @Override public Relationship createRelationship(HttpResponse res) throws
	 * TwitterException { return new RelationshipJSONImpl(res, conf); }
	 */

	/*
	 * @Override public ResponseList<Friendship>
	 * createFriendshipList(HttpResponse res) throws TwitterException { return
	 * FriendshipJSONImpl.createFriendshipList(res, conf); }
	 */
	...
	/*
	 * @Override public SavedSearch createSavedSearch(HttpResponse res) throws
	 * TwitterException { return new SavedSearchJSONImpl(res, conf); }
	 */

	/*
	 * @Override public ResponseList<SavedSearch>
	 * createSavedSearchList(HttpResponse res) throws TwitterException { return
	 * SavedSearchJSONImpl.createSavedSearchList(res, conf); }
	 */

	/*
	 * @Override public ResponseList<Location> createLocationList(HttpResponse
	 * res) throws TwitterException { return
	 * LocationJSONImpl.createLocationList(res, conf); }
	 */

	/*
	 * @Override public Place createPlace(HttpResponse res) throws
	 * TwitterException { return new PlaceJSONImpl(res, conf); }
	 */

	/*
	 * @Override public ResponseList<Place> createPlaceList(HttpResponse res)
	 * throws TwitterException { try { return PlaceJSONImpl.createPlaceList(res,
	 * conf); } catch (TwitterException te) { if (te.getStatusCode() == 404) {
	 * return new ResponseListImpl<Place>(0, null); } else { throw te; } } }
	 */
	...
	/*
	 * @Override public <T> ResponseList<T> createEmptyResponseList() { return
