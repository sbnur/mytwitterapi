...
public interface HelpResources {
	 ...
	 * This method calls https://api.twitter.com/1.1/help/privacy.json
	 * 
	 * @return privacy policy
	 * @throws twitter4j.TwitterException
	 *             when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/help/privacy">GET
	 *      help/privacy | Twitter Developers</a>
	 ...
	 * This method calls https://api.twitter.com/1.1/help/tos.json
	 * 
	 * @return Terms of Service
	 * @throws twitter4j.TwitterException
	 *             when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/help/tos">GET
	 *      help/tos | Twitter Developers</a>
	 * @since Twitter4J 2.1.7
	 */
