...
import mytwitterapi.BASE64Encoder;
...
import mytwitterapi.http.HttpRequest;
...
public class OAuthAuthorization implements Authorization, java.io.Serializable, OAuthSupport {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OAuthAuthorization.class);
