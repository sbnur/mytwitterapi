...
import mytwitterapi.auth.AccessToken;
import mytwitterapi.auth.Authorization;
import mytwitterapi.auth.AuthorizationFactory;
import mytwitterapi.auth.BasicAuthorization;
import mytwitterapi.auth.NullAuthorization;
import mytwitterapi.auth.OAuth2Authorization;
import mytwitterapi.auth.OAuth2Support;
import mytwitterapi.auth.OAuth2Token;
import mytwitterapi.auth.OAuthAuthorization;
import mytwitterapi.auth.OAuthSupport;
import mytwitterapi.auth.RequestToken;
import mytwitterapi.auth.XAuthAuthorization;
import mytwitterapi.conf.Configuration;
import mytwitterapi.http.HttpClient;
import mytwitterapi.http.HttpClientFactory;
import mytwitterapi.http.HttpResponse;
import mytwitterapi.http.HttpResponseCode;
import mytwitterapi.http.HttpResponseEvent;
import mytwitterapi.http.HttpResponseListener;
    ...
    public void httpResponseReceived(HttpResponseEvent event) {
        if (rateLimitStatusListeners.size() != 0) {
            ...
            if (rateLimitStatus != null) {
                ...
                if (statusCode == HttpResponseCode.ENHANCE_YOUR_CLAIM
